      ...
      <header className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-4 py-4 shadow-lg z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-2 flex-wrap">
            <button className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                show24h ? "bg-white text-gray-900" : "bg-gray-700 text-gray-300 hover:bg-gray-600"
              }`}
            >
          ...
          <div className="p-6">
            <div className="flex justify-between items-start mb-4">
              <div className="flex-1">
                <h2 className="text-xl font-bold mb-2">{selectedAed.name}</h2>
                <p className="text-gray-300 text-sm flex items-center gap-1">
                  <MapPin className="w-4 h-4" />
                  {selectedAed.location.street_type} {selectedAed.location.street_name},{" "}
                  {selectedAed.location.street_number}, {selectedAed.location.postal_code} Madrid
                </p>
              </div>
              <button
