...
export const metadata: Metadata = {
  ...
  description:
    "Política de privacidad de DeaMap. Información sobre el tratamiento de datos personales.",
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-6 sm:p-10">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 text-sm leading-relaxed">
          <section>
            ...
            <p>
              DeaMap es un proyecto desarrollado por <strong>Global Emergency</strong>, que actúa
              como responsable del tratamiento de los datos personales recogidos a través de este
              sitio web.
            </p>
          ...
          <section>
            ...
            <p>
              En función de cómo interactúes con DeaMap, podemos recopilar los siguientes datos:
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
              ...
              <li>
                <strong>Datos de ubicación:</strong> coordenadas geográficas proporcionadas
                voluntariamente para localizar desfibriladores cercanos.
              </li>
              <li>
                <strong>Datos de uso:</strong> información sobre tu interacción con la plataforma
                (páginas visitadas, acciones realizadas).
              </li>
              <li>
                <strong>Datos de desfibriladores:</strong> información que aportes sobre la
                ubicación, estado y características de los DEAs.
              </li>
              <li>
                <strong>Datos de organización:</strong> si gestionas una organización, datos
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li>
                <strong>Interés público:</strong> facilitar el acceso a desfibriladores puede
          ...
          <section>
            ...
            <p>
              Los datos personales se conservarán mientras mantengas tu cuenta activa. Si solicitas
              la eliminación de tu cuenta, tus datos personales serán eliminados salvo aquellos que
              debamos conservar por obligación legal. Los datos de desfibriladores que hayas
              aportado podrán mantenerse de forma anonimizada tras la eliminación de tu cuenta, dado
              su interés para la seguridad pública, salvo que solicites expresamente su retirada.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                ...
                de datos y analítica necesarios para el funcionamiento de la plataforma.
              </li>
              <li>
                <strong>Organismos públicos:</strong> cuando sea requerido por ley o para proteger
                derechos legales.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              DeaMap es una plataforma apta para todos los públicos. La parte pública de la
              plataforma (consulta del mapa y localización de desfibriladores) puede ser utilizada
              por cualquier persona sin necesidad de registro.
            </p>
            <p className="mt-2">
              Para crear una cuenta en DeaMap, los menores de 14 años necesitan el consentimiento
              verificable de su padre, madre o tutor legal, conforme al artículo 7 del RGPD y al
              artículo 7 de la Ley Orgánica 3/2018 (LOPDGDD). Si eres padre, madre o tutor y crees
              que tu hijo/a menor de 14 años nos ha proporcionado datos personales sin tu
            ...
            <p className="mt-2">
              No recopilamos deliberadamente datos personales de menores de 14 años sin
              consentimiento parental. En la parte pública de la plataforma, limitamos el uso de
              cookies de analítica y servicios de terceros para proteger la privacidad de todos los
          ...
          <section>
            ...
            <p>
              Aplicamos medidas técnicas y organizativas para proteger tus datos, incluyendo cifrado
              de contraseñas, conexiones seguras (HTTPS) y controles de acceso. No obstante, ningún
              sistema es completamente seguro y no podemos garantizar la seguridad absoluta de la
              información.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              publicado en esta página con la fecha de actualización correspondiente. Te
              recomendamos revisarla de forma periódica.
            </p>
          </section>
