...
export const metadata: Metadata = {
  ...
  description:
    "Condiciones de uso del servicio DeaMap. Términos y condiciones para el uso de la plataforma.",
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              ), aceptas estas condiciones de uso en su totalidad. Si no estás de acuerdo con alguna
              de estas condiciones, no debes utilizar la plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              desfibriladores externos automáticos (DEA) en España. El servicio incluye:
            </p>
          ...
          <section>
            ...
            <p className="mt-3">
              <strong>Uso por menores:</strong> la parte pública de DeaMap (consultar el mapa y
              localizar desfibriladores) está disponible para cualquier persona sin restricción de
              edad. Para crear una cuenta, los menores de 14 años necesitan el consentimiento de su
              padre, madre o tutor legal. Los usuarios de entre 14 y 17 años pueden registrarse por
              sí mismos. Los padres o tutores son responsables del uso que los menores a su cargo
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                Introducir información falsa o engañosa sobre la ubicación o estado de
                desfibriladores.
              </li>
          ...
          <section>
            ...
            <p>
              Los datos de desfibriladores que aportes a DeaMap (ubicaciones, imágenes,
              verificaciones, etc.) siguen siendo de tu propiedad. Al aportarlos, otorgas a DeaMap
              una licencia no exclusiva y gratuita para utilizar, mostrar y compartir públicamente
            ...
            <p className="mt-2">
              ...
              restricciones y no compartirá públicamente datos marcados como restringidos.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              ...
              de gestionar los permisos de sus miembros y de la exactitud de la información
              publicada.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              DeaMap es una herramienta informativa y colaborativa. La información sobre
            ...
            <p className="mt-2">
              <strong>En caso de emergencia médica, llama siempre al 112.</strong> DeaMap no
              sustituye la asistencia médica profesional y no se hace responsable de las decisiones
              tomadas basándose en la información de la plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              El diseño, código fuente, logotipos y contenido original de DeaMap son propiedad de
              ...
              compartirlos en la plataforma conforme a la sección 5 de estas condiciones.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              cualquier momento. Se realizarán esfuerzos razonables para notificar a los usuarios
          ...
          <section>
            ...
            <p>
              Podemos actualizar estas condiciones de uso periódicamente. Los cambios se publicarán
              en esta página con la fecha de actualización correspondiente. El uso continuado de la
              plataforma tras la publicación de los cambios constituye la aceptación de las
          ...
          <section>
            ...
            <p>
              ...
              derivada del uso de DeaMap, las partes se someterán a los juzgados y tribunales
              competentes.
            </p>
          </section>
