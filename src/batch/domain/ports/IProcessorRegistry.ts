...
export interface IProcessorRegistry {
   ...
   */
  get<TConfig extends JobConfig>(jobType: JobType): IBatchJobProcessor<TConfig> | undefined;
...
export function RegisterProcessor(jobType: JobType) {
  return function <T extends new (...args: unknown[]) => IBatchJobProcessor>(constructor: T) {
